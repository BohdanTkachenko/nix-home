...
sops_files := "nixos/secrets/wireguard.yaml home/programs/ssh/private-ssh-config home/services/secrets/winapps.yaml home/programs/ai/secrets/claude-code.yaml"
